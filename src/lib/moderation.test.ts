...
describe('moderation', () => {
  describe('validarComentarioOpcional', () => {
    it('acepta null, undefined y cadenas vacías', () => {
      expect(validarComentarioOpcional(null)).toEqual({ valido: true, valorNormalizado: null });
      expect(validarComentarioOpcional(undefined)).toEqual({ valido: true, valorNormalizado: null });
      expect(validarComentarioOpcional('')).toEqual({ valido: true, valorNormalizado: null });
      expect(validarComentarioOpcional('   ')).toEqual({ valido: true, valorNormalizado: null });
    });
